    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          _QuarterGradesSection(studentId: student.id),
          const SizedBox(height: 24),
          Text(
      ...
      children: [
        ...
        if (qGrades.isEmpty)
          _EmptyState(
            ...
            subtitle:
                context.tr('Четвертные оценки появятся после выставления учителем.'),
          )
        else
...
class _QuarterSubjectRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final sorted = grades.toList()..sort((a, b) => a.quarter.compareTo(b.quarter));
